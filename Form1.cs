...
namespace lab10
{
    public partial class player6 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if (button1.Text == "Финал")
            {
                ...
                if (playerScore[0] > playerScore[1])
                    champion.Text = finaleNames[0] + " победитель";
                else champion.Text = finaleNames[1] + " победитель";
            }
            else if (button1.Text == "Новая игра")
            {
                button1.Text = "Старт";
        ...
        private void semi3_Click(object sender, EventArgs e)
        {
